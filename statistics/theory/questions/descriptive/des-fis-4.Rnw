...
\begin{enumerate}
\item \null
\item $Q_1=\Sexpr{round(q1,4)}$ min, $Q_3=\Sexpr{round(q3,4)}$ min, $IQR=\Sexpr{round(iqr,4)}$ min.
...
\item The standard score of the Madrid sample is $z(39)=\Sexpr{round(zx,4)}$ and the standard score of the Paris one $z(39)=\Sexpr{round(zy,4)}$, thus a time of 39 min is relatively greater in the sample of Madrid.
\end{enumerate}
\end{solution}
