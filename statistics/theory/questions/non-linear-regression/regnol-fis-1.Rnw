...
<<scatterplot-injuries-warm-up, fig=T, echo=F, height=4, width=5, dev=svg, fig.path="img">>=
...
Prediction: $x(10)=\Sexpr{round(reglog$coefficients[1]+reglog$coefficients[2]*log(10),4)}$ min.
