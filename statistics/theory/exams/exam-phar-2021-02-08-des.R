...
exams2pdf(questions, n=1, name = c("exam-phar-2021-02-08-des", "solution-phar-2021-02-08-des"), encoding = "UTF-8",
  dir = "pdf",
  edir = "../questions",
...
pandoc("latex/exam-phar-2021-02-08-des1.latex", format="markdown")
