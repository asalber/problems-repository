...
exams2pdf(questions, n=1, name = c("exam-phar-2022-02-04-des", "solution-phar-2022-02-04-des"), encoding = "UTF-8",
  dir = "pdf",
  edir = "../questions",
...
pandoc("latex/exam-phar-2022-02-04-des1.latex", format="markdown")
