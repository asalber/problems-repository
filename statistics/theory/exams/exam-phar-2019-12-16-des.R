...
exams2pdf(questions, n=1, name = c("exam-phar-2019-12-16", "solution-phar-2019-12-16"), encoding = "UTF-8",
  dir = "pdf",
  edir = "../questions",
...
pandoc("latex/exam-phar-2019-12-161.latex", format="markdown")
