...
exams2pdf(questions, n=1, name = c("exam-physio-2020-05-25-des", "solution-physio-2020-05-25-des"), encoding = "UTF-8",
          dir = "pdf",
          edir = "../questions",
...
exams2pandoc(questions, n=1, 
             name = "exam-physio-2020-05-25-des", 
             encoding = "UTF-8", 
             type="latex",
             dir = "latex",
             edir = "../questions",
...
pandoc("latex/exam-physio-2020-05-25-des1.latex", format="markdown")
